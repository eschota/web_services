...
(function (global) {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      '.drawflow .drawflow-node[data-display-mode="small"] .ninput>*:not(img){display:none!important}',
      '.drawflow .drawflow-node[data-display-mode="small"] .ninput:not(:has(img:not([hidden]))){display:none!important}',
      '.drawflow .drawflow-node[data-display-mode="small"] .ninput{padding:5px 10px 9px}',
      '.drawflow .drawflow-node[data-display-mode="small"] .ninput img{width:100%;max-height:210px;object-fit:contain;background:#090a14;margin:0;border-radius:8px}',
