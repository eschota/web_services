<#
  AutoRig converter farm disk cleanup - box f11 (F11-PC) - reviewed 2026-09-23.
  ...
  * refuses to run on any machine except F11-PC;
  ...
  * logs every removed path and the freed GB to
    C:\ProgramData\AutoRigCleanup\f11-cleanup-<timestamp>.log
...
$Box        = 'f11'
$ExpectHost = 'F11-PC'
$StatusUrl  = 'http://127.0.0.1:5533/api-converter-glb/server-status'
...
$ExplicitFiles = @(
  ...
  'C:\3d\GLB_Convverter_Git\GLB_Convverter_WebServer\occonvert.log|30'
)
$RecycleSid = 'S-1-5-21-1351650869-1466163231-4022218199-1001'
# ------------------------------------------------------------------------
